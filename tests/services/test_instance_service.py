...
class TestInstanceService:
    def test_get_instance_names(
        ...
        mock_http_client.request.return_value = mock_response_from_jsonfile("v2_get_instances.json")
    ...
    def test_restart_instance(
        ...
        mock_http_client.request.return_value = mock_response(123, 300)
    ...
    def test_failover_instance(
        ...
        mock_http_client.request.return_value = mock_response(123, 100)
    ...
    def test_get_instance(
        ...
        mock_http_client.request.return_value = mock_response_from_jsonfile("v2_get_instances_instance.json")
