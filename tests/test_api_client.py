...
class TestErrorHandling:
    def test_bad_request_error_400(
        self, api_client: RAPIClient, mock_http_client: MagicMock, mock_response: Callable[[Any, int], MagicMock]
    ) -> None:
    ...
    def test_request_timeout_error(self, api_client: RAPIClient) -> None:
        with patch.object(api_client._http_client, "request", side_effect=httpx.TimeoutException("Timeout")):
